...
public class PanelSearch extends JPanel implements KeyListener,MouseListener{
	...
	public void keyReleased(KeyEvent e) { 
		if(e.getSource().equals(txtSearch)){
			PanelTable.tblSort=new TableRowSorter(PanelTable.modelbook);
			PanelTable.tblBook.setRowSorter(PanelTable.tblSort);
			PanelTable.tblSort.setRowFilter(RowFilter.regexFilter(txtSearch.getText(),0,1,2,3,4,5));
		}	
	}
